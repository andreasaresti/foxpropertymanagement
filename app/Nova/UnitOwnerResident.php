...
class UnitOwnerResident extends Resource
{
     ...
     *
     * @var class-string<\App\Models\UnitOwnerResident>
     */
    public static $model = \App\Models\UnitOwnerResident::class;
    ...
    public function fields(NovaRequest $request)
    {
        return [
            ID::make()->sortable(),
            BelongsTo::make("Unit", "Unit")->searchable(),
            BelongsTo::make("Resident", "Resident")->searchable()->showCreateRelationButton(),
